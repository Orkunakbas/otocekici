...
import DokumanArchivePage from '@/components/app/dokumanlarPage/DokumanArchivePage'
...
const Dokumanlar = () => {
  ...
  return (
    <>
      <Breadcrumbs 
        title={breadcrumbsT(`pages.dokuman-arsiv.title.${userRole}`)} 
        description={breadcrumbsT(`pages.dokuman-arsiv.description.${userRole}`)}
      />
      <DokumanArchivePage />
    </>
  )
