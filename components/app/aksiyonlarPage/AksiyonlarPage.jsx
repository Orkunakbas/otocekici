...
const AksiyonlarPage = () => {
  ...
  const filteredData = React.useMemo(() => {
    ...
    return filteredAksiyonlar.filter(item => {
    ...
    const fetchData = async () => {
      try {
        ...
        if (userInfo) {
          ...
          // Güncel aksiyonlar sayfası için güncel aksiyonları filtrele
          dispatch(updateFilteredAksiyonlar({ user: userInfo, isArchive: false }));
        }
      } catch (error) {
